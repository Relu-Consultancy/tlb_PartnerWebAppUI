    ...
    <main className="flex-1 px-6 pb-12">
      <div className="tlb-content">
        <div className="mt-8 mb-12 max-w-xl">
          ...
          <button onClick={() => onNavigate('LOGIN')} className="tlb-button mt-8 py-4 px-12 text-lg shadow-lg shadow-tlb-yellow/20">
            Get Started
          </button>
          <p className="text-gray-400 text-xs mt-4">Join 500+ premium Broadway partners</p>
        </div>

        <div className="rounded-3xl overflow-hidden mb-12 shadow-2xl max-w-2xl">
        ...
        <div className="mt-16 bg-tlb-dark rounded-[2.5rem] p-10 text-center text-white max-w-2xl">
          ...
          <button onClick={() => onNavigate('LOGIN')} className="tlb-button py-4 px-12 mx-auto">Apply Now</button>
        </div>
      </div>
    </main>
