...
export const CreateEventDetails: React.FC<EventProps> = ({ onNavigate }) => (
  <div className="min-h-screen bg-gray-50 pb-24">
    ...
    <main className="p-6 space-y-8">
      ...
      <button onClick={() => onNavigate('CREATE_EVENT_TICKETS')} className="tlb-button w-full py-5 shadow-xl shadow-tlb-yellow/20">
...
export const CreateEventTickets: React.FC<EventProps> = ({ onNavigate }) => (
  <div className="min-h-screen bg-gray-50 pb-24">
    ...
    <main className="p-6 space-y-8">
      ...
      <button onClick={() => onNavigate('CREATE_EVENT_REVIEW')} className="tlb-button w-full py-5 shadow-xl shadow-tlb-yellow/20">
...
export const EventReviewStatus: React.FC<EventProps> = ({ onNavigate }) => (
  <div className="min-h-screen bg-tlb-dark flex flex-col items-center justify-center p-8 text-center">
    ...
    <div className="w-full space-y-4">
      <button onClick={() => onNavigate('EVENT_LISTINGS')} className="tlb-button w-full py-5">Back to Listings</button>
      <button onClick={() => onNavigate('DASHBOARD')} className="w-full py-5 text-gray-400 font-black text-sm uppercase tracking-widest">Dashboard</button>
    </div>
  </div>
);
