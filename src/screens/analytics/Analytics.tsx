...
import { ArrowLeft, Bell, ArrowUpRight, Calendar, Ticket } from 'lucide-react';
                ...
                <section className="space-y-4">
                    ...
                    <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                        <div className="flex justify-between items-start mb-2">
                            ...
                            <div className="bg-emerald-100 text-emerald-600 px-2 py-1 rounded-lg text-xs font-black flex items-center gap-1"><ArrowUpRight size={14} /> 12%</div>
                        </div>
                ...
                <section className="space-y-4">
                    ...
                    <div className="bg-[#FDFCF8] rounded-2xl border border-gray-100 overflow-hidden">
                        <div className="grid grid-cols-3 p-4 bg-[#F8F9FA] border-b border-gray-100 text-xs font-bold text-gray-500">
                            <div>Date</div><div className="text-right">Amount</div><div className="text-right">Status</div>
                        </div>
                        <div className="divide-y divide-gray-50">
                            {[
                                ...
                                <div key={i} className="grid grid-cols-3 p-4 items-center bg-white text-sm">
                                    ...
                                    <div className="flex justify-end"><span className={`text-[10px] font-bold px-2 py-0.5 rounded uppercase ${row.color}`}>{row.status}</span></div>
                                </div>
                            ))}
                        </div>
                    </div>
