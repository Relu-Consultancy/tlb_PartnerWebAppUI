        ...
        >
                ...
                {cover ? (
                    <div className="relative w-full sm:w-80 aspect-[16/9] rounded-2xl overflow-hidden border border-gray-200">
                        ...
                        <button
                            ...
                            className="absolute bottom-2 right-2 bg-white/90 px-3 py-1.5 rounded-lg shadow text-xs font-bold text-tlb-yellow hover:bg-white disabled:opacity-50"
                        >
                    ...
                    <button
                        onClick={() => coverInputRef.current?.click()}
                        disabled={busyKind === 'cover'}
                        className="w-full sm:w-80 aspect-[16/9] bg-tlb-yellow/10 rounded-2xl border-2 border-dashed border-tlb-yellow/30 flex flex-col items-center justify-center text-tlb-yellow hover:bg-tlb-yellow/20 transition-colors disabled:opacity-60"
                    >
                        ...
                        <span className="text-[10px] text-tlb-yellow/70 mt-1">JPG/PNG · Max 5 MB</span>
                    </button>
                )}
            </div>
                ...
                <div className="flex flex-wrap gap-3">
                    ...
                    {gallery.length < GALLERY_LIMIT && (
                        <button
                            ...
                            className="w-24 h-24 bg-tlb-yellow/10 rounded-2xl border-2 border-dashed border-tlb-yellow/30 flex flex-col items-center justify-center text-tlb-yellow hover:bg-tlb-yellow/20 transition-colors disabled:opacity-60"
                        >
                            {busyKind === 'gallery'
            ...
            <div>
                ...
                {video ? (
                    <div className="bg-gray-50 border border-gray-100 rounded-2xl p-4 flex items-center gap-3">
                        <div className="bg-tlb-yellow/10 p-3 rounded-xl text-tlb-yellow"><Play size={20} /></div>
                        <div className="flex-1 min-w-0">
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="text-[10px] text-tlb-yellow truncate block hover:underline"
                            >
            ...
            {!cover && (
                <div className="bg-amber-50 border border-amber-200 rounded-2xl p-3 text-[11px] font-bold text-amber-700">
                    Cover image is required to submit this listing.
                </div>
            )}
