...
import { Menu, Bell, ChevronRight, TrendingUp, ReceiptIndianRupee, UserCircle, CheckCircle2, BarChart3 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 pb-24">
        <header className="bg-white p-6 flex items-center justify-between sticky top-0 z-30 border-b border-gray-100">
            ...
            <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-full bg-tlb-yellow/10 flex items-center justify-center text-tlb-yellow"><UserCircle size={24} /></div>
            </div>
        </header>
        <main className="p-6">
            <div className="tlb-content space-y-8">
                ...
                <section className="tlb-card p-4">
                    ...
                    <div className="w-full h-2 bg-gray-100 rounded-full overflow-hidden"><div className="h-full bg-tlb-yellow w-3/4"></div></div>
                </section>
