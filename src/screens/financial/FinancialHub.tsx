...
import { Menu, DollarSign, Download, ShieldCheck, AlertCircle, Building2, Smartphone, X } from 'lucide-react';
import { Screen } from '../../types';

interface Props { onNavigate: (screen: Screen) => void; onOpenSidebar: () => void; }

const MOCK_TRANSACTIONS = [
    { id: 'TRX-101', date: '15 Mar 2026', amount: '₹14,500', status: 'Settled' },
    { id: 'TRX-102', date: '01 Mar 2026', amount: '₹22,100', status: 'Settled' },
    { id: 'TRX-103', date: '15 Feb 2026', amount: '₹8,400', status: 'Settled' },
];

const FinancialHub: React.FC<Props> = ({ onNavigate, onOpenSidebar }) => {
    // Toggle for testing UI states
                ...
                <div className="p-4 md:p-8 tlb-content space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm relative overflow-hidden group">
                            ...
                            <h3 className="text-3xl font-black text-gray-900 relative z-10">₹45,000</h3>
                        ...
                        <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-sm relative overflow-hidden group">
                            ...
                            <h3 className="text-3xl font-black text-red-500 relative z-10 text-opacity-80">-₹4,500</h3>
                        </div>
                        <div className="bg-gradient-to-br from-tlb-dark to-gray-900 p-6 rounded-3xl shadow-lg relative overflow-hidden group">
                            ...
                            <h3 className="text-3xl font-black text-tlb-yellow relative z-10">₹12,400</h3>
                        </div>
                    </div>
                        ...
                        <div className="space-y-6">
                                ...
                                <div className="relative z-10 space-y-4">
                                    ...
                                    <div className="flex justify-between items-end">
                                        <div>
                                            ...
                                            <p className="font-bold text-sm tracking-wide">TLB Partner</p>
                                        </div>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <button onClick={() => setActiveModal('bank')} className="bg-white border border-gray-100 hover:border-tlb-yellow hover:shadow-md hover:-translate-y-0.5 transition-all p-5 rounded-2xl flex flex-col items-center justify-center gap-3 group shadow-sm">
                                    ...
                                    <span className="text-xs font-bold text-gray-600">Add Bank</span>
                                </button>
                            ...
                            {/* KYC Warning (only if needed) */}
                            {!isKycVerified && (
                                <div className="bg-orange-50 border border-orange-100 p-4 rounded-2xl mt-4">
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-900/40 backdrop-blur-sm">
                    <div className="bg-white rounded-3xl w-full max-w-md overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-200">
                        <div className="p-6 border-b border-gray-100 flex items-center justify-between">
                            <h2 className="font-black text-xl">Add Bank Account</h2>
                        ...
                        <div className="p-6 space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" className="tlb-input w-full" placeholder="e.g. HDFC0001234" />
                            </div>
                            <div>
                                <label className="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-1.5">Account Holder Name</label>
                                <input type="text" className="tlb-input w-full" placeholder="As per bank records" />
                            </div>
                        </div>
