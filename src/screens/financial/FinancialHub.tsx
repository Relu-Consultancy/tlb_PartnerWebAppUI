...
import { Menu, TrendingUp, ReceiptIndianRupee, ArrowUpRight, Building2, Filter, CheckCircle2 } from 'lucide-react';
            ...
            <div className="tlb-content space-y-8">
                <div className="grid grid-cols-2 gap-4">
                    <div className="tlb-card p-6">
                        <div className="flex items-center gap-2 text-[10px] font-black text-tlb-yellow uppercase tracking-widest mb-4"><TrendingUp size={12} /> Total Earned</div>
                        <p className="text-3xl font-black">$12,450</p>
                        <p className="text-[10px] font-black text-emerald-500 uppercase tracking-widest mt-2 flex items-center gap-1"><ArrowUpRight size={10} /> +12.5%</p>
                    </div>
                    <div className="tlb-card p-6">
                        <div className="flex items-center gap-2 text-[10px] font-black text-tlb-yellow uppercase tracking-widest mb-4"><ReceiptIndianRupee size={12} /> Available</div>
                        <p className="text-3xl font-black">$3,200</p>
                        <p className="text-[10px] font-black text-emerald-500 uppercase tracking-widest mt-2 flex items-center gap-1"><ArrowUpRight size={10} /> +5.2%</p>
                    </div>
                </div>
