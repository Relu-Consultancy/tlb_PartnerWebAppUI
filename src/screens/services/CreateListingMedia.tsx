            ...
            <div className="tlb-content space-y-6">
                ...
                <div>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        {/* Upload buttons */}
                        <div className="aspect-square bg-tlb-yellow/10 rounded-2xl border-2 border-dashed border-tlb-yellow/30 flex flex-col items-center justify-center text-tlb-yellow cursor-pointer hover:bg-tlb-yellow/20 transition-colors">
                            <Camera size={24} />
