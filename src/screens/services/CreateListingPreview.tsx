...
export const CreateListingPreview: React.FC<Props> = ({ onNavigate }) => (
    <div className="min-h-screen bg-gray-50 pb-8">
        <header className="bg-white p-6 flex items-center justify-between sticky top-0 z-30 border-b border-gray-100">
            <button onClick={() => onNavigate('CREATE_LISTING_POLICIES')} className="p-2 -ml-2"><ArrowLeft size={24} /></button>
            <div className="text-center">
                <h1 className="font-black text-lg">New Listing</h1>
                <p className="text-[10px] font-bold text-tlb-yellow uppercase tracking-widest">Stage 5 of 5 — Preview & Publish</p>
            </div>
            <div className="w-10" />
        </header>
            ...
            <div className="tlb-content space-y-6">
                ...
                <div className="bg-white rounded-3xl border-2 border-gray-200 overflow-hidden shadow-xl max-w-md mx-auto">
                    ...
                    <div className="h-48 relative">
                        ...
                        {/* Edit button overlay */}
                        <button onClick={() => onNavigate('CREATE_LISTING_MEDIA')} className="absolute bottom-3 right-3 bg-white/90 p-2 rounded-xl shadow text-gray-600 hover:bg-white transition-colors">
                            <Edit3 size={14} />
                        </button>
                    </div>
                    ...
                    <div className="p-5 space-y-4">
                        <div className="flex items-start justify-between">
                            <div>
                                ...
                                <p className="text-[10px] font-bold text-tlb-yellow uppercase tracking-widest mt-0.5">Coding & Robotics › Robotics</p>
                            </div>
                            <button onClick={() => onNavigate('CREATE_LISTING_IDENTITY')} className="text-gray-400 hover:text-tlb-yellow p-1">
                                <Edit3 size={14} />
                            </button>
                        </div>
                        ...
                        <div className="relative">
                            ...
                            <button onClick={() => onNavigate('CREATE_LISTING_IDENTITY')} className="absolute -top-1 -right-1 text-gray-400 hover:text-tlb-yellow p-1">
                                <Edit3 size={12} />
                            </button>
                        </div>
                        ...
                        <div className="space-y-2">
                            <div className="flex items-center justify-between">
                                ...
                                <button onClick={() => onNavigate('CREATE_LISTING_BATCH')} className="text-gray-400 hover:text-tlb-yellow p-1">
                                    <Edit3 size={12} />
                                </button>
                            </div>
                            {[
                                { name: 'Morning Batch', days: 'Mon, Wed, Fri', time: '10:00–11:30 AM', spots: '5 spots left' },
                                { name: 'Weekend Batch', days: 'Sat', time: '2:00–3:30 PM', spots: '12 spots left' },
                            ].map((batch, i) => (
