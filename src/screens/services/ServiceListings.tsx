                        ...
                        {filtered.map((service) => (
                            <div key={service.id} className={`bg-white rounded-2xl border overflow-hidden transition-all ${service.status === 'Paused' ? 'border-gray-200 opacity-75' : 'border-gray-100'}`}>
                                    ...
                                    <div className="flex items-start justify-between">
                                        ...
                                        <div className="flex items-center gap-3">
                                            <button
                                                ...
                                                className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-bold transition-colors ${service.status === 'Live'
                                ...
                                <div className="border-t border-gray-100 px-5 py-3 flex justify-end">
                                    <button onClick={() => onNavigate('CREATE_LISTING_IDENTITY')} className="flex items-center gap-1.5 text-xs font-bold text-tlb-yellow uppercase tracking-widest hover:underline">
