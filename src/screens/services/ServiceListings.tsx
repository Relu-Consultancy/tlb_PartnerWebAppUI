...
const mockListings = [
    {
        id: '1', title: 'Hatha Yoga', category: 'Yoga & Wellness', entityType: 'Classes' as EntityType, status: 'Live' as const,
        batches: [
    ...
    {
        id: '2', title: 'Kids Contemporary Dance', category: 'Dance & Movement', entityType: 'Classes' as EntityType, status: 'Live' as const,
        batches: [
            { name: 'Weekend Morning', days: 'Sat', time: '10:00–11:30 AM', capacity: 25, enrolled: 22 },
        ]
    },
    {
        id: '3', title: 'Summer Art Workshop', category: 'Arts & Crafts', entityType: 'Events' as EntityType, status: 'Live' as const,
        batches: [
            { name: 'June Batch', days: 'Mon–Fri', time: '10:00–12:00 PM', capacity: 30, enrolled: 18 },
        ]
    },
    {
        id: '4', title: 'Keyboard Basics', category: 'Music & Instruments', entityType: 'Classes' as EntityType, status: 'Paused' as const,
        batches: [
            { name: 'Sunday Batch', days: 'Sun', time: '11:00 AM–12:00 PM', capacity: 10, enrolled: 0 },
        ]
    },
    {
        id: '5', title: 'Weekend Robotics Camp', category: 'STEM & Innovation', entityType: 'Events' as EntityType, status: 'Live' as const,
        batches: [
